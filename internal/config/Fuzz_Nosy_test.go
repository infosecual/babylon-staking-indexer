...
func Fuzz_Nosy_BBNConfig_Validate__(f *testing.F) {
...
func Fuzz_Nosy_MetricsConfig_GetMetricsPort__(f *testing.F) {
	f.Fuzz(func(t *testing.T, data []byte) {
...
func Fuzz_Nosy_MetricsConfig_Validate__(f *testing.F) {
	f.Fuzz(func(t *testing.T, data []byte) {
